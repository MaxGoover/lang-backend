...
class m200726_223156_fill_459_present_simple_exercise_collection extends Migration
{
    private array $_sentences = [
        ...
        'Им это нужно.',
        'Он знает эту компанию. Её прибыль кажется очень большой',
        'Он хочет жить в другом месте.',
        'Мне тоже нравится это место.',
        'Он хотел бы пойти в другое место.',
        'Мне нужно отдохнуть.',
        'Мы поддерживаем тебя.',
        'Я вижу, это ему очень нравится.',
        'Им это нравится.',
        'Я все знаю.',
    ...
    public function up()
    {
        $translations = [
            ...
            ['We often goes to the cinema.'],
            ['They need it.'],
            ['He knows this company. Its profit seems so big.'],
            ['He wants to live it another place.'],
            ['I also like this place.'],
            ['He`d like to go to another place.'],
            ...
            ['He really needs to learn English as soon as possible.'],
            ['I agree with you.'],
            ['He really loves her.'],
            ['I go to work.'],
            ['All people know it.'],
