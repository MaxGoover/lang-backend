...
class m200821_173823_fill_passive_past_simple_statement_exercise_collection extends Migration
{
    private array $_sentences = [
        ...
        'Никто не был упомянут.',
        'Его отправили в тюрьму.',
        'Его благословили делать это.',
        'Наша встреча была отложена.',
        'Ожидалось, что он придет туда.',
        'Было обещано, что это будет сделано.',
        'Предполагалось, что он даст ей эти деньги.',
        'Он был ранен.',
        'Его выбрали.',
        'Это было сделано вовремя.',
        'Злая собака была поймана.',
        '.',
        '.',
    ];
    ...
    public function up()
    {
        $translations = [
            ...
            ['He was blessed to do it.'],
            ['Our meeting was postponed.'],
            ['He was expected to come there.'],
            ['It was promised that it would be done.'],
